    ...
    <tr>
      ...
      ?>
        <td>
          ...
          </button><button class="btn btn-danger btn-sm ml-1" onclick="del_backend(<?= $row['id'] ?>)">刪除</button>
        </td>
    </tr>
  <?php  }  ?>
...
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#Modal1">新增後端技能</button>
<!-- Modal -->
<div class="modal fade " id="Modal1" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">新增後端技能</h5>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" onclick="save_backend()">新增</button>
      </div>
    </div>
  </div>
</div>
...
<script>
  $(".ubtn").on("click", function() {
    ...
    $.get("../api/read_backend.php", {
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">取消</button>
        <button type="button" class="btn btn-primary" onclick="save_backend(${result['id']})">更新</button>
      </div>
  ...
  function del_backend(id) {
    $.post("../api/del_backend.php", {
      id
    }, function(res) {
      if (res == 1) {
        alert("刪除成功");
...
<div class="modal fade " id="Modal2" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">更新後端技能</h5>
        <button type="button" class="close" data-dismiss="modal">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
